  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I'm creative designer based in Pondicherry-India, and I'm very
        passionate and dedicated to my work.A Highly motivated and creative
        developer with hands-on, a successful software engineer with 6+ years of
        verifiable success in learning teams with comprehensive knowledge of
        ...
        Technology Direction And Deep Technical Expertise. Ready To Take On And
        Work In Any Project Immediately Without Further Delay Even From Scratch
        -Advantage worked with Swedish , Nordic , London, Indian clients so I
        can adapt and join with any team with ease.
      </p>
