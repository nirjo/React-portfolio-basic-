...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Nirmalraj Joseph
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       <h3 className="home__subtitle">Frontend Developer | consultant </h3>
       <p className="home__description">
       I'm creative designer based in Pondicherry-India, and I'm very passionate and dedicated to my work.
